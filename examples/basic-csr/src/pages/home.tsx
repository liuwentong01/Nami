    ...
    <div className={`page-home ${isDark ? 'theme-dark' : 'theme-light'}`}>
      <section className="hero">
        ...
        <p className="hero-desc">
          ...
          查看页面源代码可以看到临时骨架和资源标签，但不包含真实页面内容。
        </p>
      </section>
      ...
      <section className="theme-section">
        ...
        <button onClick={handleToggleTheme}>切换到{isDark ? '浅色' : '深色'}主题</button>
      </section>

      <section className="features">
        <h2>CSR 模式特点</h2>
        <ul>
          <li>服务端返回带临时骨架的 HTML Shell，JS 加载后在浏览器渲染真实内容</li>
          <li>支持丰富的客户端交互，状态管理更灵活</li>
          <li>真实内容首屏依赖 JS 下载和执行，等待期间由骨架提供反馈</li>
